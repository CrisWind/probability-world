#!/usr/bin/env node
/* Phase D: patch-fleet-ui.js
 * Creates fleet-ui.js — overlay, 5 areas, 3 views.
...
console.log('[Phase D] fleet-ui.js');

const fleetUiContent = `/* 概率世界 · 商会船队风险盘 V0.1 —— UI（覆盖层 + 3 视图）
 * 只显示客观信息，不显示推荐。
...
writeFile('fleet-ui.js', fleetUiContent, 'FleetUI');
verifySyntax('fleet-ui.js');
